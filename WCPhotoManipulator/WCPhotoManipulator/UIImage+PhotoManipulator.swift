...
public extension UIImage {
    ...
    public func overlayImage(_ overlay: UIImage, position: CGPoint, scale: CGFloat? = nil) -> UIImage? {
        UIGraphicsBeginImageContextWithOptions(self.size, true, scale ?? self.scale)
